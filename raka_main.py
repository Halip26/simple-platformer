...
class Player(pygame.sprite.Sprite):  # Class parent
    ...
    def __init__(self):
        ...
        # List of sprites we can bump againts
        self.level = None
    ...
    def jump(self):
        ...
        self.rect.y += 2  # The player is moved downward by 2 pixels just to check if they are touching a platform.
        platform_hit_list = pygame.sprite.spritecollide(
            self, self.level.platform_list, False
        )
        self.rect.y -= 2  # The player is moved upward
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        # Set a reference to the the image rect
        self.rect = self.image.get_rect()
...
class Spike(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        # Create a tringular spike image
